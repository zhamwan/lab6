...
public class CollectionManager{
    ...
    public Response insert(Flat flat, int key){
    ...
    public Response removeKey(int key){
        if (checkKey(key)){
     ...
     * @param flat
     */
    public Response update( int key, Flat flat){
        if (checkKey(key)){
            collection.remove(key);
            collection.put(key, flat);
     ...
     * @return
     */
    public Response replaceIfLowe(int key, Flat flat){
